...
FROM centos:latest as metron
MAINTAINER "lambdhack" <lambdhack@lambdhack.bzh>
...
#COPY ansible.cfg /metron/
#ENV ANSIBLE_CONFIG /metron/ansible.cfg
...
# clone metron repo for mvn build later
RUN git clone https://github.com/apache/metron.git /home/metron/metron.git
